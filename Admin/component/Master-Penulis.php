        ...
        <div class="data-indicator">
            <div class="data-entries">
                ...
                <select id="selection" name="selection"
                    onchange="
                    let value = $(this).val();
                    $('#isi-data').load('component/result/penulis.php?lim=' + value + '&&page=<?= $halamanAktif ?>&&key=' + $('#search').val())">
            ...
            <div class="data-search">
                ...
                $('#isi-data').load(
                    'component/result/penulis.php?lim=' + $('#selection').val() + '&&page=<?= $halamanAktif ?>&&key=' + $(this).val()
                )">
            </div>
        </div>
        <!-- isi data -->
            ...
            <div class=" description">
                ...
                <div class="pagination">
                    ...
                    <?php if ($halamanAktif < $jumlahHalaman): ?>
                        <button onclick="
                    $('.isi-data').load('component/result/penulis.php?lim=<?= $dataPerHalaman ?>&&page=<?= $halamanAktif + 1 ?>&&key=' + $('#search').val())'
                    )">
                            Next
