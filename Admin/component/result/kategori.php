...
$kategor = mysqli_query($db, "SELECT * FROM buku WHERE kategori LIKE '%$key%' ORDER BY id DESC LIMIT $awalData, $dataPerHalaman");
    ...
    <div class="description">
        ...
        <div class="pagination">
            <?php if ($halamanAktif > 1): ?>
                ...
                $('.isi-data').load(
                    'component/result/kategori.php?lim=<?= $dataPerHalaman ?>&&page=<?= $halamanAktif - 1 ?>&&key=<?= $key ?>'
                )">
